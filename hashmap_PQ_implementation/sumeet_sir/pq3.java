...
{		
		...
		public pq3(Comparator<T> comptr){
			this.comptr=comptr;
		}
		...
		{		
			Comparable<T> ith = (Comparable<T>) al.get(i);
...
//			this.type=var; //this needed here
	...
	public static void main(String[] args) {
		...
		pq3<student> p = new pq3<>( new valComparator() ) ;
		
//		pq3<student> p = new pq3<>( Collections.reverseOrder(new valComparator()) ) ;
...
//		pq3<student> p = new pq3<>( Collections.reverseOrder(new valComparator()) ) ;
		...
		System.out.println();
//		pq3<student> p2 = new pq3<>( new valLIComparator() ) ;
		
		pq3<student> p2 = new pq3<>( Collections.reverseOrder(new valComparator()) ) ;
									// Collections.reverseOrder()
